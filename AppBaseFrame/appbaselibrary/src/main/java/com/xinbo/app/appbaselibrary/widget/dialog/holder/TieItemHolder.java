...
import com.xinbo.app.appbaselibrary.widget.dialog.listener.OnItemClickListener;
...
public class TieItemHolder extends SuperItemHolder<TieBean> {
    ...
    public void refreshView() {
        ...
        if (itemPositionType == 1) {
            llTie.setBackgroundResource(R.drawable.app_base_dialogui_selector_all_top);
        } else if (itemPositionType == 3) {
            llTie.setBackgroundResource(R.drawable.app_base_dialogui_selector_all_bottom);
        } else if (itemPositionType == 4) {
            llTie.setBackgroundResource(R.drawable.app_base_dialogui_selector_all);
        } else {
            llTie.setBackgroundResource(R.drawable.app_base_dialogui_selector_all_no);
        }
