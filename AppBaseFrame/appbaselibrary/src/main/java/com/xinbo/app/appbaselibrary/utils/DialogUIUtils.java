...
import com.xinbo.app.appbaselibrary.widget.dialog.listener.DialogAssigner;
...
import com.xinbo.app.appbaselibrary.widget.dialog.widget.PopuWindowView;
    ...
    private static void showToast(String str, int showTime, int gravity) {
        ...
        if (gravity == Gravity.TOP) {
            if (mToastTop == null) {
                ...
                View view = inflate.inflate(R.layout.app_base_dialogui_toast, null);
                mToastTop.setView(view);
                mToastTop.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.app_base_dialogui_toast_margin));
            }
            mToast = mToastTop;
            mToast.setText(str);
            mToast.show();
            ...
            if (mToastBottom == null) {
                ...
                mToastBottom.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.app_base_dialogui_toast_margin));
            }
            mToast = mToastBottom;
            mToast.setText(str);
            mToast.show();
