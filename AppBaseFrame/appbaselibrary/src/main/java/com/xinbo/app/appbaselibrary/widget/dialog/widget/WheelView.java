...
package com.xinbo.app.appbaselibrary.widget.dialog.widget;
...
import com.xinbo.app.appbaselibrary.widget.dialog.adapter.WheelAdapter;
import com.xinbo.app.appbaselibrary.widget.dialog.listener.OnWheelChangedListener;
import com.xinbo.app.appbaselibrary.widget.dialog.listener.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.app_base_dialogui_wheel_val);
        }
