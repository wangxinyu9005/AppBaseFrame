package com.xinbo.app.appbaselibrary.widget.dialog.holder;
...
public class AlertDialogHolder extends SuperHolder {
    ...
    protected int setLayoutRes() {
        return R.layout.app_base_dialogui_holder_alert;
    }
    ...
    public void assingDatasAndEvents(Context context, final BuildBean bean) {
        ...
        if (TextUtils.isEmpty(bean.text3)) {
            if (bean.isVertical) {
                ...
                btn2Vertical.setBackgroundResource(R.drawable.app_base_dialogui_selector_all_bottom);
            } else {
                btn3.setVisibility(View.GONE);
                lineBtn3.setVisibility(View.GONE);
                btn2.setBackgroundResource(R.drawable.app_base_dialogui_selector_right_bottom);
            }
        ...
        if (TextUtils.isEmpty(bean.text2)) {
            if (bean.isVertical) {
                ...
                btn1Vertical.setBackgroundResource(R.drawable.app_base_dialogui_selector_all_bottom);
            } else {
                btn2.setVisibility(View.GONE);
                lineBtn2.setVisibility(View.GONE);
                btn1.setBackgroundResource(R.drawable.app_base_dialogui_selector_right_bottom);
            }
        } else {
            if (bean.isVertical) {
