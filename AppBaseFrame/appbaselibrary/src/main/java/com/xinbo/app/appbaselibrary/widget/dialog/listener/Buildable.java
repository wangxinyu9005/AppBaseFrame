package com.xinbo.app.appbaselibrary.widget.dialog.listener;
...
import com.xinbo.app.appbaselibrary.widget.dialog.DialogConfig;
import com.xinbo.app.appbaselibrary.widget.dialog.bean.BuildBean;
import com.xinbo.app.appbaselibrary.widget.dialog.holder.AlertDialogHolder;
import com.xinbo.app.appbaselibrary.widget.dialog.holder.SheetHolder;
import com.xinbo.app.appbaselibrary.widget.dialog.utils.ToolUtils;
...
public class Buildable {
    ...
    private BuildBean buildDatePick(final BuildBean bean) {
        AlertDialog.Builder builder = new AlertDialog.Builder(bean.mContext,R.style.app_base_alertDialog);
        View root = View.inflate(bean.mContext, R.layout.app_base_dialogui_datepick_layout, null);
    ...
    protected BuildBean buildMdLoading(BuildBean bean) {
        ...
        View root;
        if (bean.isVertical) {
            root = View.inflate(bean.mContext, R.layout.app_base_dialogui_loading_vertical, null);
        } else {
            root = View.inflate(bean.mContext, R.layout.app_base_dialogui_loading_horizontal, null);
        }
        ...
        if (bean.isWhiteBg) {
            llBg.setBackgroundResource(R.drawable.app_base_dialogui_shape_wihte_round_corner);
            pbBg.setIndeterminateDrawable(bean.mContext.getResources().getDrawable(R.drawable.app_base_dialogui_rotate_mum));
            tvMsg.setTextColor(bean.mContext.getResources().getColor(R.color.app_base_text_black));
        } else {
            llBg.setBackgroundResource(R.drawable.app_base_dialogui_shape_gray_round_corner);
            pbBg.setIndeterminateDrawable(bean.mContext.getResources().getDrawable(R.drawable.app_base_dialogui_rotate_mum_light));
