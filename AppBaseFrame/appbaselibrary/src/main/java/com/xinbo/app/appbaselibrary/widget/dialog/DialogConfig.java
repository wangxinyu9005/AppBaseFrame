package com.xinbo.app.appbaselibrary.widget.dialog;
...
public class DialogConfig {
    ...
    @ColorRes
    public static int iosBtnColor = R.color.app_base_ios_btntext_blue;
    @ColorRes
    public static int lvItemTxtColor = R.color.app_base_text_item_33;
    @ColorRes
    public static int mdBtnColor = R.color.app_base_btn_alert;
    @ColorRes
    public static int titleTxtColor = R.color.app_base_text_title_11;
    @ColorRes
    public static int msgTxtColor = R.color.app_base_text_title_11;
    @ColorRes
    public static int inputTxtColor = R.color.app_base_text_input_44;
