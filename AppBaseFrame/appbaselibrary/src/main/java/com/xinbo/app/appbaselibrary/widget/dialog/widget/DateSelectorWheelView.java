...
import com.xinbo.app.appbaselibrary.widget.dialog.adapter.StrericWheelAdapter;
...
public class DateSelectorWheelView extends RelativeLayout implements
    ...
    private void initLayout(Context context) {
        LayoutInflater.from(context).inflate(R.layout.app_base_dialogui_datepick_date_selector_layout, this,
                true);
